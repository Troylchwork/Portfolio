...
import { Stack, Paper, Button, Dialog, DialogTitle, DialogContent, TextField, DialogActions, IconButton } from "@mui/material";
...
export default function Website() {
    ...
    const columns = [
        ...
        // 注意：如果你不需要雙擊修改單元格，建議把 editable: true 刪除
            ...
            <Dialog open={open} onClose={handleCloseDialog}>
                ...
                <DialogContent>
                    <Stack spacing={2} sx={{ mt: 1, minWidth: 300 }}>
                        ...
                        <TextField label="Age" type="number" fullWidth value={formData.age} onChange={(e) => setFormData({ ...formData, age: e.target.value })} />
                    </Stack>
                </DialogContent>
                <DialogActions>
